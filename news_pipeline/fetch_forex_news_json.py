...
Examples:
    .venv/bin/python -m news_pipeline.fetch_forex_news_json --symbol USDIDR
    .venv/bin/python -m news_pipeline.fetch_forex_news_json --all
    .venv/bin/python -m news_pipeline.fetch_forex_news_json --url https://id.tradingview.com/symbols/USDIDR/news/ --symbol USDIDR
"""
